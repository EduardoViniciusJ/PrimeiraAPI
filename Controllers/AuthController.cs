...
namespace PrimeiraAPI.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Revoke(string username)
        {
            ...
            // Faz com que o refresh token sejá nulo, forçando o usuário fazer o login.
        ...
        public async Task<IActionResult> CreateRole(string roleName)
        {
            ...
            if (!roleExist)
            {
                ...
                {
                    return Ok($"Papel do usuário criado com sucesso {roleName}");
                }
                else
                {
                    return BadRequest($"Problemas ao criar o papel do usuário {roleName}");
                }
            }
            return BadRequest($"Usuário já existe {roleName}");
        }
        ...
        public async Task<IActionResult> AddUserToRole(string email, string roleName)
        {
            ...
            if (user != null)
            {
                ...
                if (result.Succeeded)
                {
                    return Ok($"Adicionado o papel do usuário com sucesso, usuário {email} e o papel {roleName}");
                } else
                {
                    return BadRequest($"Erro ao adicionar um papel para o usuário");
                }
            }
